  ...
  return (
    <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-100 mb-8 flex flex-col md:flex-row gap-4">
      <div className="relative flex-1">
        ...
        <Input
          type="text"
          placeholder={t.superadmin.searchStoresPlaceholder}
          value={searchTerm}
      ...
      >
        <option value="all">{t.superadmin.statusAll}</option>
        <option value="active">{t.superadmin.statusActiveOnly}</option>
        <option value="inactive">{t.superadmin.statusInactiveOnly}</option>
      </Select>
    </div>
  );
}
